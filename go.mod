...
require (
	github.com/antinvestor/apis/go/common v1.9.8
	github.com/antinvestor/apis/go/notification v1.9.8
	github.com/antinvestor/apis/go/partition v1.9.8
	github.com/antinvestor/apis/go/profile v1.9.8
