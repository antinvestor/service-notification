...
require (
	...
	github.com/antinvestor/apis/go/settings v1.49.5
	github.com/pitabwire/frame v1.69.3
...
require (
	buf.build/gen/go/antinvestor/partition/protocolbuffers/go v1.36.11-20251216063854-8a831e5d0734.1 // indirect
