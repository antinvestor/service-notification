...
INSERT INTO template_data(id, tenant_id, partition_id,  template_id, language_id, type, detail, subject, created_at, modified_at) VALUES
	('9bsv0s23l8og00vgjq90', 'c2f4j7au6s7f91uqnojg', 'c2f4j7au6s7f91uqnokg', '9bsv0s23l8og00vgjq90', '9bsv0s23l8og00vgjqa0', 'text', 'Your contact verification code is : {{.code}} and will expire at {{.expiryDate}}', 'login verification code', '2020-01-08 21:22:30',  '2020-01-08 21:22:30');
