...
VALUES ('9bsv0s5943v0036a8sp0', '9bsv0s0hijjg02qks6dg', '9bsv0s0hijjg02qks6i0',
        ...
        'nats://core-queue-headless.queue-system.svc.cluster.local:4222?subject=svc.notification.integration.emailsmtp.send.queue',
       ...
       ('9bsv0s5943v0036a8tp5', '9bsv0s0hijjg02qks6dg', '9bsv0s0hijjg02qks6i0',
        ...
        'nats://core-queue-headless.queue-system.svc.cluster.local:4222?subject=svc.notification.integration.africastalking.send.queue',
        '2024-01-15 07:45:30', '2024-01-15 07:45:30'),
       ...
       ('9bsv0s0d0smg0339ldvh', '9bsv0s0hijjg02qks6jg', '9bsv0s0hijjg02qks6kg',
        'Stawi Production Send', 'Channel to send stawi sms messages', 'tx', 'any',
        'nats://core-queue-headless.queue-system.svc.cluster.local:4222?subject=svc.notification.integration.africastalking.send.queue',
        '2024-01-15 07:45:30', '2024-01-15 07:45:30');
